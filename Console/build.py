...
def render_topic(topic_entries):
    ...
    # Use a list to accumulate string fragments instead of repeated string concatenation (+=).
    # This avoids O(N^2) memory reallocation overhead when building large HTML strings.
    md_parts = []
